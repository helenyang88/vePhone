...
def settings(tmp_path: Path) -> Settings:
    return Settings(
        ...
        mobile_use_access_key_id=None,
        mobile_use_secret_access_key=None,
        mobile_use_product_id=None,
        mobile_use_account_id=None,
        mobile_use_sts_role_trn=None,
        mobile_use_stream_token_ttl_seconds=None,
        mobile_use_pod_id=None,
        mobile_use_ark_api_key=None,
        mobile_use_tos_bucket=None,
        mobile_use_tos_endpoint=None,
        mobile_use_tos_region=None,
        mobile_use_use_base64_screenshot=None,
        mobile_use_max_step=None,
        mobile_use_timeout_seconds=None,
        mobile_use_callback_info=None,
        mobile_use_output_schema=None,
        mobile_use_retry_limit=None,
        mobile_use_system_prompt=None,
        mobile_use_screen_record=None,
        mobile_use_mcp_json=None,
        mobile_use_max_output_tokens=None,
        mobile_use_gps_info=None,
    )
