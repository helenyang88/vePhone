...
const FEATURES = [
  ...
  { icon: "M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3", text: "Mobile Use 真机执行链路" },
      ...
      <div className="auth-brand">
        <div className="auth-brand-inner">
          <div className="auth-brand-top">
            ...
            <div>
              <div className="auth-brand-name">MUA Test</div>
              <span className="auth-brand-tag">Mobile UI automation</span>
            </div>
          </div>
        </div>
        ...
        <div className="auth-brand-inner">
          <h1 className="auth-brand-h1">
            <span className="auth-title-primary">让移动端自动化测试</span><br />
            <span className="gradient">更可追踪</span>
          </h1>
          <p className="auth-brand-desc">
            围绕用例、测试计划、真机执行和报告沉淀，统一管理移动端 UI 自动化测试流程。
          </p>
