...
from cua_platform.pods.schemas import PodDetail, PodPoolSnapshot, VerifiedPodAllocation
...
from cua_platform.tasks.repository import PodLeaseConflict, SQLiteTaskRepository
from cua_platform.time import Clock, SystemClock
from cua_platform.traces.schemas import TraceSpanDraft


logger = logging.getLogger("cua_platform.pod_leases")
...
class PodPoolService:
    ...
    async def allocate_for_case(
        ...
        *,
        ...
        from cua_platform.tasks.models import Task as _Task  # noqa: F401
